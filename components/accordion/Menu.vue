...
.accordion-item-trigger-icon-wrapper {
  @apply w-7 h-7 bg-transparent transition-colors duration-300 flex rounded-full items-center justify-center;
}
...
@screen md {
  ...
  .accordion__item .accordion__item .accordion__trigger {
    @apply -mt-1;
  }
}
