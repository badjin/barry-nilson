<template>
  <form
    ...
    action="/get-in-touch/?success=true&form=2#content"
    method="POST"
    ...
    @submit="submit"
  >
    <input type="hidden" name="form-name" value="Contact-Insurance" />
    <p class="hidden">
      <label>
...
export default {
  ...
  data() {
    return {
      ...
      interestedInOption: '',
      interestedInOptions: [
        { value: 'legalEnquiry', label: 'Legal Enquiry' },
