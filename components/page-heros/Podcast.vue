  ...
  <div class="bg-steelblue text-white">
    <div class="tc-container-image pl-5 md:pl-10 py-c-mobile md:py-c-desktop">
      <div class="pt-50px md:pt-80px">
        ...
        >
          <div
            class="flex flex-col justify-between w-full md:w-10/12 lg:w-6/12 pr-10"
          >
            <h1 class="tc-h1">
            ...
            <div class="flex flex-col md:flex-row md:justify-between mt-4">
              ...
              <div v-if="module.categories && module.categories.length">
                ...
                <div class="flex space-x-3">
                  <div v-for="category in module.categories" :key="category.id">
