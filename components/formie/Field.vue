<template>
  <div
    ...
    v-bind="attrs"
    :data-field-conditions="field.conditions"
  >
...
<script>
import { attributesTable } from '@/models/formie/helpers'

import AllInputs from '@/components/formie/inputs'

// Import separately, as they can't be nested
import Group from '@/components/formie/inputs/Group.vue'
import Repeater from '@/components/formie/inputs/Repeater.vue'
